...
export default class Project5 extends Component {
  ...
  that they have achieved...but also set goals and keep themselves on track to accomplish them. That is where MyRecovery comes in.<br /><br />
          <a href='http://myrecovery.surge.sh'><img alt={'largeProjectPic'} class='largeProjectPic' src={myrecoveryscreenshot} /></a><br /><br />
      ...
      time left on your goal via the progress bars.</li>
              <li>A library of links to outside resources</li>
